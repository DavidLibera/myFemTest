========================================================================
    STATIC LIBRARY : GLKLib Project Overview
========================================================================

AppWizard has created this GLKLib library project for you. 

This file contains a summary of what you will find in each of the files that
make up your GLKLib application.
...
StdAfx.h, StdAfx.cpp
    ...
    named GLKLib.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "GLKLib.rc" and a "GLKLib.h" that 
