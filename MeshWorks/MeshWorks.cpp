...
// CMeshWorksApp construction

CMeshWorksApp::CMeshWorksApp()
{
...
// The one and only CMeshWorksApp object

CMeshWorksApp theApp;


// CMeshWorksApp initialization

BOOL CMeshWorksApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMeshWorksDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CMeshWorksView));
	if (!pDocTemplate)
		return FALSE;
