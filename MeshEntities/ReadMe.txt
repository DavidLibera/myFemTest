========================================================================
    STATIC LIBRARY : MeshEntities Project Overview
========================================================================

AppWizard has created this MeshEntities library project for you. 

This file contains a summary of what you will find in each of the files that
make up your MeshEntities application.
...
StdAfx.h, StdAfx.cpp
    ...
    named MeshEntities.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "MeshEntities.rc" and a "MeshEntities.h" that 
